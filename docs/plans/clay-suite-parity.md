...
| Agents | Agent/research columns, MCP and Copilot surfaces; versioned chained research playbooks with prior-step context, an Agents composer, bounded audience runs, durable per-profile results, in-place failed-profile retries that preserve successful work and frozen prompts, restart-safe recurring schedules, and signed capability maturity | Controlled-live certification of grounded research, chaining, audience runs, retries, and schedules | P1 |
