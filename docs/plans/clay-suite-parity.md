...
| Activation | Durable audience destination runs and delivery ledger for webhooks, HubSpot, Salesforce and paid media; authenticated idempotent CRM inbound reconciliation with conflict policies; outreach/output columns | Warehouse sync, additional destination drivers and controlled-live CRM validation | P1 |
