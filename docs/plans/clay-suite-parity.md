...
| Activation | Durable audience destination runs and delivery ledger for webhooks, HubSpot and Salesforce; outreach/output columns | Bidirectional CRM/warehouse sync and additional destination drivers | P1 |
